...
namespace power_car_base_simple_controller {
...
PLUGINLIB_EXPORT_CLASS(power_car_base_simple_controller::BaseSimpleController, controller_interface::ControllerBase)
