...
#include <gohi_hw/transport_tcp_server.h>
#include <unistd.h>
...
//first modify *************************
    ...
    boost::shared_ptr<UdpLinkClient> client_udp_;
    boost::shared_ptr<TcpServer> server_tcp_;
 ...
 //   boost::shared_ptr<HFLink> hflink_;
    ...
    inline void sendCommandModbus(const MotorModbusCommand command_state)
    {
        ...
        client_udp_->writeBuffer(data);
               //发送数据
        // client_udp_->SendData("abcdedfg",8,true);
